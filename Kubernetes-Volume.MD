...
##### *```NOTE```: node1.txt which was created in /volume/hostpath/ of Node#1 can be viewed from Pod(). Similarly, node2.txt which was created in /volume/hostpath/ of Node#2 can be viewed from inside Pod().*
<hr>
